...
'''
 @project: Python_test
 @file: Server.py
 @function:socket通信服务器端，定义成函数，Server_GUI可以调用函数并直接启动服务端
 @author:  linxin
 @date:  7/4/2020 - 11:09 AM
'''
...
# 定义成函数，Server_GUI可以调用函数并直接启动服务端
# 设置服务器的IP和端口
...
# 开始写
with open(r'static/%s' % filename, "wb") as f:  # 写在本地的static目录下
    for _ in progress:
        # 从客户端读取数据
